...
description: In this activity you will create a project filter named "All projects in the Marketing portfolio" and another project filter named "Projects I Own Closing This Month."
activity: use
...
doc-type: video
TQID: https://experienceleague.adobe.com/XRpVGO1FcCi5kIZE98iZy2dWz0uzOI4MqczxEAurNQg
product_v2:
...
1. Click the **[!UICONTROL Filter]** menu and select [!UICONTROL Legacy Filters] if it's not already selected.
1. Select **[!UICONTROL New Filter]**.
1. Name your filter "All projects in the Marketing portfolio."
1. Click **[!UICONTROL Add Filter Rule]**.
1. Click on the **Select a field** field and start typing the words "[!UICONTROL portfolio name]." Then select [!UICONTROL Name] under the [!UICONTROL Portfolio] field source.
1. Leave the [!UICONTROL Equal] operator as it is.
1. Type "[!UICONTROL marketing]" in the search field.
...
![An image of the screen to create a new filter](assets/basic-filter-activity-2.png)
...
1. Click **[!UICONTROL Add Filter Rule]**.
1. Click on the **Select a field** field and start typing the word "Owner." Now click on Owner ID under the [!UICONTROL Project] field source.
1. Leave the [!UICONTROL Equal] operator as it is.
1. Type "$$" in the search field.
1. Select [!UICONTROL $$USER.ID]. This is the wildcard for the logged-in user.
1. Click on add another filter rule. 
1. Click on the **Select a field** field and start typing the word "Is Complete." Now click on "Is Complete" under the [!UICONTROL Project] field source.
1. Leave the [!UICONTROL Equal] operator as it is.
1. Select "False."
1. Click on add another filter rule again.
1. Click on the **Select a field** field and start typing the word "Planned." Now click on "Planned Completion Date" under the [!UICONTROL Project] field source.
